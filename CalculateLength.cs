...
namespace LineComputation
{
    public class CalculateLength
    {
        public static void get()
        {
            ...
            Console.WriteLine("Enter X end coordinate number of line1 i.e x2 : ");
            int x2 = Convert.ToInt32(Console.ReadLine());
            Console.WriteLine("Enter Y end coordinate number of line1 i.e y2 : ");
            int y2 = Convert.ToInt32(Console.ReadLine());
            CalculatetheLength(x1, y1, x2, y2);

        }
        public static void CalculatetheLength(int x1, int y1, int x2, int y2)
        {
